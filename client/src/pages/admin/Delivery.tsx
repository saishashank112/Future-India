  ...
  return (
    <div className="space-y-8 pb-12 font-sans">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-serif font-bold text-primary italic">Logistics Command</h1>
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Global delivery tracking and fulfillment protocol</p>
        </div>
      </header>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-50/50">
                <th className="py-6 px-8">Dispatch ID</th>
                <th className="py-6 px-8">Settlement</th>
                <th className="py-6 px-8">Consignee</th>
                ...
                <tr key={order.id} className="hover:bg-gray-50/50 transition-all group">
                  <td className="py-6 px-8">
                     <div className="flex flex-col">
                        ...
                        <span className="text-[9px] font-bold text-gray-300 uppercase tracking-widest mt-1">Active Route</span>
                     </div>
                  </td>
                  <td className="py-6 px-8">
                  ...
                  <td className="py-6 px-8">
                    <div className="flex flex-col">
                        <span className="text-xs font-bold text-primary italic font-serif leading-none mb-1">{order.customer_name}</span>
                        <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-none">Registered Client</span>
                    </div>
                  </td>
                  <td className="py-6 px-8">
                    <div className="relative inline-block w-40">
                      <select 
                        ...
                        className={`w-full appearance-none px-4 py-1.5 rounded-full text-[9px] font-bold uppercase tracking-widest pr-8 cursor-pointer transition-all border ${
                  ...
                  <td className="py-6 px-8">
                     <span className={`px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-widest ${
                        ...
                        order.payment_status === 'Pending Verification' ? 'bg-blue-100 text-blue-700' :
                  ...
                  <td className="py-6 px-8">
                    {order.latitude ? (
                        ...
                        <a 
                          href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(order.address || 'India')}`} 
                          target="_blank" 
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-lg text-[9px] font-bold uppercase tracking-widest text-primary hover:bg-accent hover:text-white transition-all shadow-sm"
                        >
            ...
            >
              ...
              <div className="flex-1 p-16 overflow-y-auto">
                    <div className="flex justify-between items-start mb-12">
                         <div>
                            <div className="flex items-center gap-3 mb-4">
                                <span className="px-4 py-1.5 bg-accent/10 text-accent rounded-full text-[10px] font-bold uppercase tracking-[0.3em]">Dispatch Protocol</span>
                    ...
                    <div className="space-y-6 pt-10 border-t border-gray-100">
                         <h4 className="text-[10px] font-bold text-primary uppercase tracking-widest">Update Dispatch Status</h4>
                         <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            {['PENDING', 'PACKING', 'SHIPPED', 'OUT FOR DELIVERY', 'DELIVERED', 'CANCELLED'].map(s => (
                                <button
                                    key={s}
